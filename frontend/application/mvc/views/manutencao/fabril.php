<section id="maintenance-fabril" class="maintenance fabril cbp-so-section">
    ...
    <div class="sub-content" data-slide-contents="true">
        <div>
            ...
            <div class="hp-slideshow">
                <div class="owl-carousel main-slideshow-prodution-<?php echo $counter ?>">
                ...
                <div class="nav-crtl owl-theme">
                    <div class="container">
                        <div class="owl-controls">
                            <div id="nav-crtl-prodution-<?php echo $counter ?>" class="owl-nav"></div> 
                            <div id="nav-dot-prodution-<?php echo $counter ?>" class="owl-dots "></div>  
                        </div>
                    </div>  
                </div> 
            </div>
